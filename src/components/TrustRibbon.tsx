  ...
  return (
    ...
    >
      <span className="flex items-center gap-1.5 text-[#111827]">
        <Banknote className="w-5 h-5 text-[#111827] inline-block ml-1.5 align-sub" /> الدفع عند الاستلام
      </span>
      <span className="flex items-center gap-1.5 text-[#111827]">
        <Truck className="w-5 h-5 text-[#111827] inline-block ml-1.5 align-sub" /> توصيل مجاني
      </span>
      <span className="flex items-center gap-1.5 text-[#111827]">
